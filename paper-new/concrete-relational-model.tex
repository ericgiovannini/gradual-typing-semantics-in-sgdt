...
with a notion of syntactic perturbation.
...
universal property of the coproduct of monoids (see appendix for details).
...
M_{A_1} \oplus M_{A_2}$. The interpretation is defined using the universal property
of the coproduct (see appendix for the details).
