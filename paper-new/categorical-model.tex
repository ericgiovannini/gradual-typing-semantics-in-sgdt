...
the monoid of perturbations, but which we actually mean there is an element $p \in P_A$
that is mapped to $f$ under the homomorphism.

We require that $\delta_{UB}^* \in P_{UB}$ for all $A$, where $\delta_{UB}^*$ is the distinguished
