...
this. These usual rules are given in Section
\ref{sec:appendix-gtlc-syntax} in the Appendix\max{extended
  version}. The reason for our presentation choice has to do with our
