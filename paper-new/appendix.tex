...
\begin{proof}
  ...
  % https://q.uiver.app/#q=
  \[\begin{tikzcd}[ampersand replacement=\&]
    FA \& {FA'} \\
    FA \& {FA'}
    \arrow["Fc", "\shortmid"{marking}, no head, from=2-1, to=2-2]
    \arrow["Fc", "\shortmid"{marking}, no head, from=1-1, to=1-2]
    \arrow["{(\delta_{FA}^*)^n \circ F(\ptb_A(a))}"', from=1-1, to=2-1]
    \arrow["{(\delta_{FA'}^*)^n \circ F(\ptb_{A'}(\push_c(a)))}", from=1-2, to=2-2]
  \end{tikzcd}\]

  This is obtained by pasting $n$ copies of the square $\delta_{FA}^* \ltdyn_{Fc}^{Fc} \delta_{FA'}^*$
  on top of the square obtained by lifting via $F$ the square corresponding to the push property for $c$.
