...
\begin{itemize}
  % \li
  \item Then to interpret the perturbations as endomorphisms, by the universal property
  ...
  \item To construct the homomorphism $i_{A_1 \times A_2}$, we
  ...
  \item To
  construct the interpretation as endomorphisms $i_{A \arr B}$ it suffices to define a
