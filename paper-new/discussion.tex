...
quasi-representable.\max{need to say what's not formalized}
...
built-in to Guarded Cubical Agda. The mechanization of adequacy also required us
to formalize some essential lemmas involving clocks and clock-irrelevance; we
are considering later refactoring these as part of a ``standard library'' for
Guarded Cubical Agda.\max{say these axioms are taken from prior work and cite that}
